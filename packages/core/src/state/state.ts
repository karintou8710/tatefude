...
export class EditorState {
  ...
  /** 適用した状態は `tr.state`。`Transaction.extender` の追記もここで入る */
...
function resolveChanges(
  ...
  doc: Plot,
  current: Plot,
  spec: ChangeSet | ChangeSpec | readonly ChangeSpec[] | undefined,
): ChangeSet {
